...
class RebrickableDatabase():
	root_path = os.getcwd() + '/GenerativeLEGO/'
        #Open the database
	with open(root_path + 'database/brick_type_db.json', 'r') as fp:
		brick_types = json.load(fp)

	#Open the database
	with open(root_path + 'database/brick_size_db.json', 'r') as fp:
	...
	def update_brick_size(self, new_key, new_val):
		...
		with open(self.root_path + 'database/brick_size_db.json', 'w') as fp:
			json.dump(new_db, fp)
	...
	def update_brick_size(self, new_key, new_val):
		...
		with open(self.root_path + 'database/brick_type_db.json', 'w') as fp:
			json.dump(new_db, fp)
