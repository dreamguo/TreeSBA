...
for brick_i in range(1, MAX_T):
    for dir_i in range(2):
        ...
        if pos_dir[3] == 0:
            OFFSET[dir_i, brick_i, 0][1] += -2
            OFFSET[dir_i, brick_i, 1][1] += -1
            OFFSET[dir_i, brick_i, 2][1] += 0
            OFFSET[dir_i, brick_i, 3][1] += 1
            OFFSET[dir_i, brick_i, 4][1] += -2
            OFFSET[dir_i, brick_i, 5][1] += -1
            OFFSET[dir_i, brick_i, 6][1] += 0
            OFFSET[dir_i, brick_i, 7][1] += 1

            OFFSET[dir_i, brick_i, 4][0] -= 1
            OFFSET[dir_i, brick_i, 5][0] -= 1
            OFFSET[dir_i, brick_i, 6][0] -= 1
            OFFSET[dir_i, brick_i, 7][0] -= 1
        else:
            OFFSET[dir_i, brick_i, 0][0] += -2
            OFFSET[dir_i, brick_i, 1][0] += -1
            OFFSET[dir_i, brick_i, 2][0] += 0
            OFFSET[dir_i, brick_i, 3][0] += 1
            OFFSET[dir_i, brick_i, 4][0] += -2
            OFFSET[dir_i, brick_i, 5][0] += -1
            OFFSET[dir_i, brick_i, 6][0] += 0
            OFFSET[dir_i, brick_i, 7][0] += 1

            OFFSET[dir_i, brick_i, 4][1] -= 1
            OFFSET[dir_i, brick_i, 5][1] -= 1
            OFFSET[dir_i, brick_i, 6][1] -= 1
            OFFSET[dir_i, brick_i, 7][1] -= 1
